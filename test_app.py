...
class TestApp(unittest.TestCase):
    ...
    # Prepare test data
        ...
        # TODO: Get Response from API endpoint '/api/subtract'
        ...
        # TODO: Assert equals if API response 'result' is -1 (4 - 5)
    ...
    #     # Write test code here
        ...
        # TODO: Get Response from API endpoint '/api/divide'
        ...
        # TODO: Assert equals if API response 'result' is 0.8 (4 / 5)
        self.assertEqual(response.json, {"result": 0.8})
